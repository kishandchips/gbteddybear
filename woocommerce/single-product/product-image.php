	...
	if ( $attachment_ids ) {
		...
		if ( has_post_thumbnail() ) {
			...
			<div class="scroll-item current" data-id="<?php echo get_post_thumbnail_id(); ?>">
				<?php echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<a href="%s" itemprop="image" class="woocommerce-main-image zoom" title="%s"  rel="prettyPhoto' . $gallery . '">%s</a>', $image_link, '', $image ), $post->ID ); ?>
			</div>
		<?php 
		}
	}
