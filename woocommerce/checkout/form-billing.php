...
<?php if ( ! is_user_logged_in() && $checkout->enable_signup ) : ?>
	...
	<div class="create-account">
		...
		<p class="no-margin"><?php _e( 'Create an account by entering the information below. If you are a returning customer please login at the top of the page.', 'woocommerce' ); ?></p>
