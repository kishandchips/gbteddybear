...
<div id="order_review" class="col2-set">
	...
	<div id="payment" class="col-2">
		...
		<div class="form-row place-order">
			...
			echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="green-btn" name="woocommerce_checkout_place_order" id="place_order" value="' . $order_button_text . '" />' );
			?>
